...
public class QualificationSettings implements Serializable {
    ...
    public void editQualificationSettings(QualificationSettings qualificationSettings){
        disciplineWhere = qualificationSettings.getDisciplineWhere();
        qByPlace = qualificationSettings.getQByPlace();
        qByTime = qualificationSettings.getQByTime();
    }
