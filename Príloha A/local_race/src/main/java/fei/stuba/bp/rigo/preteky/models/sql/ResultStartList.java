...
public class ResultStartList implements Serializable {
    ...
    public void editResultStartList(ResultStartList resultStartList){
        startPerformance= resultStartList.getStartPerformance();
        resultPerformance= resultStartList.getResultPerformance();
        place= resultStartList.getPlace();
        line= resultStartList.getLine();
        reaction= resultStartList.getReaction();
        absoluteOrder= resultStartList.getAbsoluteOrder();
        points = resultStartList.getPoints();
        status = resultStartList.getStatus();
    }
}
