...
import fei.stuba.socket.database.models.ClubTransfer;
...
public interface ClubTransferRepository extends JpaRepository<ClubTransfer, Integer>, JpaSpecificationExecutor<ClubTransfer> {
